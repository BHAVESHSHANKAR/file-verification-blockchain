    ...
    return (
        <div className="p-4 md:p-10">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Pending Votes */}
                <div className="mt-8 bg-white dark:bg-neutral-800 rounded-xl p-8 border border-neutral-200 dark:border-neutral-700">
                    ...
                    {loading ? (
                        ...
                        <div className="space-y-4">
                            {requests.map((request) => (
                                <div
                                    key={request._id}
                                    className="border border-neutral-200 dark:border-neutral-700 rounded-lg p-6 hover:bg-neutral-50 dark:hover:bg-neutral-900/50 transition-colors"
                                >
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="grid grid-cols-2 gap-4 text-sm">
                                                <div>
                                                    ...
                                                    <p className="text-neutral-800 dark:text-neutral-200 font-medium">@{request.username}</p>
                                                </div>
                                                <div>
                                                    <p className="text-neutral-500 dark:text-neutral-400">Email</p>
                                                    <p className="text-neutral-800 dark:text-neutral-200 font-medium">{request.email}</p>
                                                </div>
                                            </div>
